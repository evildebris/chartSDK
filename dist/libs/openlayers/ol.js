...
(function (root, factory) {
  ...
  */
  ...
  function Qb(a) {
    ...
    else if ("string" === typeof a && (b = Kb[a] || null, !b)) {
  ...
  function Cc(a, b, c, d) {
    for (var e, f = 0, g = a.length; f < g; ++f)
      if (e = a[f], e.listener === b && e.rh === c) return d && (e.deleteIndex = f), e
  }
  ...
  Nc.prototype.addEventListener = function (a, b) {
    var c = this.pa[a];
    c || (c = this.pa[a] = []); - 1 === c.indexOf(b) && c.push(b)
  };
  ...
  k.K = function (a, b, c) {
    if (Array.isArray(a))
      for (var d = 0, e = a.length; d < e; ++d) Hc(this, a[d], b, c);
    else Hc(this, a, b, c)
  };
  ...
  function Vc(a, b) {
    ...
    this.a = a ? a : [];
    if (this.c)
      for (a = 0, b = this.a.length; a < b; ++a) Wc(this, this.a[a], a);
    Xc(this)
  }
  v(Vc, Qc);
  k = Vc.prototype;
  ...
  k.jq = function (a, b) {
    var c = this.ec();
    if (a < c) this.c && Wc(this, b, a), c = this.a[a], this.a[a] = b, this.b(new Zc("remove", c)), this.b(new Zc("add", b));
    else {
  ...
  function Wc(a, b, c) {
    for (var d = 0, e = a.a.length; d < e; ++d)
      if (a.a[d] === b && d !== c) throw new ua(58);
  }
  var Yc = "length";
  ...
  function ld(a) {
    if (a = a.frameState) {
      var b, c, d, e, f, g = a.layerStatesArray,
        h = rb({}, a.attributions),
        l = {},
        m = {},
  ...
  var Jd, Kd = "undefined" !== typeof navigator ? navigator.userAgent.toLowerCase() : "",
    Ld = -1 !== Kd.indexOf("firefox"),
    Md = -1 !== Kd.indexOf("safari") && -1 == Kd.indexOf("chrom"),
    Nd = -1 !== Kd.indexOf("webkit") && -1 == Kd.indexOf("edge"),
    Od = -1 !== Kd.indexOf("macintosh"),
    ...
    window,
    Td = "geolocation" in navigator,
    Ud = "ontouchstart" in window,
    Vd = "PointerEvent" in window,
    Wd = !!navigator.msPointerEnabled,
    Xd = !1,
    Yd, Zd = [];
  ...
  function yf(a, b, c, d, e, f, g, h, l, m, n) {
    ...
    for (var q = n ? n : [NaN, NaN], t = b + d; t < c;)
      if (vf(a, t - d, t, d, g, h, q), p = Ea(g, h, q[0], q[1]), p < m) {
        m = p;
  ...
  function Mf(a, b, c, d, e, f) {
    ...
    for (g = c.length; b < g; ++b)
      if (Lf(a, c[b - 1], c[b], d, e, f)) return !1;
    return !0
  };
  ...
  function Rf(a, b, c, d, e) {
    ...
    for (f = c.length; b < f; ++b)
      if (Kf(a, c[b - 1], c[b], d, e)) return !1;
    return !0
  };
  ...
  k.Xf = function (a, b) {
    ...
    else va(Array.isArray(a), 24), va(!ib(a), 25), d = Yf(a);
    var e = b.padding ? b.padding : [0, 0, 0, 0],
  ...
  function rh(a) {
    ...
    if (void 0 !== a.keyboard ?
      a.keyboard : 1) b.push(new bh), b.push(new dh({
      delta: a.zoomDelta,
      duration: a.zoomDuration
    }));
  ...
  function bi(a, b) {
    var c = a.f,
      d = a.I;
    d ? d.fillStyle != b.fillStyle && (d.fillStyle = c.fillStyle = b.fillStyle) : (c.fillStyle = b.fillStyle, a.I = {
  ...
  k.Bf = function (a, b) {
    var c = Ji(b, Mi, Oi);
    if (this.Va) var d = this.Va;
    else this.Va = d = new Pi(a, c);
    b.Tc(c);
  ...
  function gj(a, b, c, d) {
    ...
    for (e = 0; e < c; e += d) {
      ...
      if (e)
        if (e === c - d) {
          if (m) var x = B;
          else t = t || [0, 0], f = hj(a, t, u, [0, 0], p * ij * (l || 1), f), f = hj(a, t, u, [0, 0], -p * ij * (l || 1), f), a.b[g++] = q, a.b[g++] = n - 1, a.b[g++] = n, a.b[g++] = n, a.b[g++] = q + 1, a.b[g++] = q, l && (f = hj(a, t, u, [0, 0], p * jj * l, f), f = hj(a, t, u, [0, 0], -p * jj * l, f), a.b[g++] = q + 2, a.b[g++] = q,
  ...
  (function (a) {
    ...
    e.prototype = {
      ...
      jh: function (a, b, c) {
        ...
        e.children.push(a);
        for (h(e, c); 0 <= b;)
          if (d[b].children.length > this.Pf) this.uk(d, b), b--;
          else break;
        this.ik(c, d, b)
      },
      uk: function (a, b) {
  ...
  function Rj(a, b, c, d, e, f) {
    ...
    if (f === Sf(b, 0, b.length, c)) {
      ...
      for (p = b.length - c, n = f = Xj(a, b[p], b[p + 1], h++), p -= c, g = 0; p >= g; p -= c) q = Xj(a, b[p], b[p + 1], h++), m.push(Yj(n, q, d)), l.push([Math.min(n.x, q.x), Math.min(n.y, q.y), Math.max(n.x, q.x), Math.max(n.y, q.y)]), n = q;
    m.push(Yj(q, f, d));
  ...
  function Vj(a, b, c, d, e) {
    ...
    l = f.W;
    if (0 < g && (f = bk(b, t, f.W, e), f.length))
      for (t = Infinity, m = 0, h = f.length; m < h; ++m)
        if (g = f[m], n = Math.atan2(b.y - g.y, d.x - g.x), n < t || n === t && g.x < l.x) t = n, l = g;
  ...
  k.Qb = function (a, b, c, d, e, f) {
    if (this.ua) {
      ...
      f = this.ua.split("\n");
      var g = nk(this, f),
        h, l, m = Math.round(g[0] * this.jb - this.ta),
        n = Math.round(g[1] * this.oa - this.ga),
  ...
  function Bk(a, b, c, d) {
    var e = a.f,
      f = b.fb();
    if (a.a.b.hasOwnProperty(f)) a = a.a.get(f), e.bindTexture(3553, a.Hb), 9729 != a.Yh && (e.texParameteri(3553, 10240, 9729), a.Yh = 9729), 9729 != a.$h && (e.texParameteri(3553, 10241, 9729), a.$h = 9729);
    else {
  ...
  k.Ik = function (a, b) {
    ...
    for (var c; 1024 < this.a.c - this.g;) {
      if (c = this.a.a.bd) a.deleteTexture(c.Hb);
      else if (+this.a.a.vc == b.index) break;
      else --this.g;
      this.a.pop()
    }
  };
  ...
  function Mk(a) {
    ...
    if (b && b.c && c) {
      ...
      var g = e[0];
      e = e[1];
      if ("bottom-right" == f || "center-right" == f || "top-right" == f) "" !== a.a.Te && (a.a.Te = b.left = ""), g = d[0] - c[0] - g + "px", a.a.yf != g && (a.a.yf = b.right = g);
      else {
      ...
      if ("bottom-left" == f || "bottom-center" == f || "bottom-right" == f) "" !== a.a.Ef &&
        (a.a.Ef = b.top = ""), c = d[1] - c[1] - e + "px", a.a.Be != c && (a.a.Be = b.bottom = c);
      else {
  ...
  function sl(a) {
    if ("function" !== typeof a) {
      ...
      else va(a instanceof ql, 41), b = [a];
      a = function () {
        return b
      }
    }
  ...
  function xl(a) {
    ...
    if ("function" === typeof a) 2 == a.length ? b = function (b) {
      ...
      else va(a instanceof ql, 41), c = [a];
      b = function () {
        return c
      }
    }
  ...
  function Bl(a, b, c) {
    if (a.nodeType == Node.CDATA_SECTION_NODE || a.nodeType == Node.TEXT_NODE) b ? c.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g, "")) : c.push(a.nodeValue);
      ...
      for (a = a.firstChild; a; a = a.nextSibling) Bl(a, b, c);
    return c
  }
    ...
    return function (e, f, g) {
      ...
      h.onload = function () {
        if (!h.status || 200 <= h.status && 300 > h.status) {
          ...
          else "xml" == a ? (e = h.responseXML) || (e = El(h.responseText)) : "arraybuffer" == a && (e = h.response);
  ...
  function Wl(a, b, c) {
    var d = c ? Qb(c.featureProjection) : null,
      e = c ? Qb(c.dataProjection) : null,
      f;
  ...
  function am(a, b, c, d, e, f) {
    ...
    for (f = b.length; e < f; ++e) {
      ...
      if (g != h) {
        if (d < a[g + c - 1]) break;
        else if (d <= a[h - 1]) return $l(a, g, h, c, d, !1);
        g = h
      }
    }
    return null
  ...
  k.cd = function (a, b) {
    ...
    var c = {},
      d = a.V();
    d && (c.geometry = km(d, b), b && b.featureProjection && (c.geometry.spatialReference = {
  ...
  k.he = function (a, b) {
    var c = a.localName,
      d = null;
    if ("FeatureCollection" == c) "http://www.opengis.net/wfs" === a.namespaceURI ? d = L([], this.b, a, b, this) : d = L(null, this.b, a, b, this);
  ...
  function io(a, b) {
    if (a = a.V())
      if (a = ho[a.T()]) return zl(b[b.length - 1].node.namespaceURI, a)
  }
  var jo = K(Cn, {
  ...
  k.clone = function () {
    var a = this.Y(1);
    if (2 === this.b.f)
      if ("IMG" === a.tagName.toUpperCase()) var b = a.cloneNode(!0);
      else {
  ...
  function vo(a) {
    a = a ? a : {};
    Rm.call(this);
    wo || (xo = [255, 255, 255, 1], yo = new pl({
      color: xo
    }), zo = [20, 2], Ao = Bo = "pixels", Co = [64, 64], Do = "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png", Eo = .5, Fo = new to({
      anchor: zo,
  ...
  function cp(a, b) {
    ...
    if (c)
      if ("Point" == d) {
        ...
        g.aa(c, d);
        ep(g, a)
      } else "LineString" == d ? (g = new N(null), bm(g, a), ep(g, a)) : "Polygon" == d ? (g = new P(null), dm(g, a), ep(g, a)) : "GeometryCollection" == d ? g = new Im(a) : va(!1, 37);
    else g = new Im(a);
    return g
  }
  ...
  function Gp(a, b) {
    ...
    for (c = b.firstElementChild; c; c = c.nextElementSibling)
      if (ha(Mo, c.namespaceURI) && "name" == c.localName) return Q(c);
    for (c = b.firstElementChild; c; c = c.nextElementSibling)
      if (b = c.localName, ha(Mo, c.namespaceURI) && ("Document" == b || "Folder" == b || "Placemark" == b || "kml" == b) && (b = Gp(a, c))) return b
  }
  k.Qp = function (a) {
    var b = [];
  ...
  function Up(a, b, c) {
    ...
    if (f = b.bb())
      if (f = f.call(b, 0)) f = Array.isArray(f) ? f[0] : f, this.j && (a.Style = f), (f = f.Ja()) && (a.name = f.Ja());
  ...
  (function (a) {
    ...
    b.prototype = {
      ...
      Aq: function (a) {
        ...
        else if (a === b.b) this.fa = this.La() + this.fa;
        else if (a === b.a) this.fa += 4;
        else if (a === b.f) this.fa += 8;
  ...
  (function (a) {
    ...
    d.prototype.Xh = function () {
      ...
      for (var b = a.La() + a.fa, d = 1, e = 0, f = 0, g = 0, h = [], l; a.fa < b;)
        if (e || (e = a.La(), d = e & 7, e >>= 3), e--, 1 === d || 2 === d) f += a.ie(), g += a.ie(), 1 === d && (l && h.push(l), l = []), l.push(new c(f, g));
        else if (7 === d) l && l.push(l[0].clone());
    ...
    d.prototype.bbox = function () {
      ...
      for (var b = a.La() + a.fa, c = 1, d = 0, e = 0, f = 0, g = Infinity, h = -Infinity, l = Infinity, m = -Infinity; a.fa < b;)
        if (d || (d = a.La(), c = d & 7, d >>=
            3), d--, 1 === c || 2 === c) e += a.ie(), f += a.ie(), e < g && (g = e), e > h && (h = e), f < l && (l = f), f > m && (m = f);
  ...
  function qr(a, b) {
    for (b = b.firstChild; b; b = b.nextSibling)
      if (b.nodeType == Node.ELEMENT_NODE) return rr(a, b)
  }
  var sr = {
    "http://www.opengis.net/gml": {
  ...
  function or(a) {
    for (a = a.firstChild; a; a = a.nextSibling)
      if (a.nodeType == Node.ELEMENT_NODE) return L({}, pr, a, [])
  }
  var wr = {
    "http://www.opengis.net/wfs": {
      PropertyName: J(dn)
  ...
  var Br = {
    "http://www.opengis.net/wfs": {
      Query: J(function (a, b, c) {
        ...
        if (d = d.filter) g = zl("http://www.opengis.net/ogc", "Filter"), a.appendChild(g), Ql({
          node: g
        }, Br, Ll(d.lc), [d], c)
      })
    },
  ...
  mr.prototype.Mg = function (a) {
    for (a = a.firstChild; a; a = a.nextSibling)
      if (a.nodeType == Node.ELEMENT_NODE) return this.vf(a);
    return null
  };
  ...
  k.sp = function () {
    if (Sr(this, 2)) {
      var a;
      if (2 == this.b.type)
        for (a = [this.Bg()]; Sr(this, 5);) a.push(this.Bg());
      else a = Yr(this);
      if (Sr(this, 3)) return a
    } else if (Tr(this)) return [];
    throw Error(Ur(this));
  ...
  k.Jb = function (a, b, c, d) {
    ...
    if (b < d) {
      if (b)
        for (d = this.ud() / Math.sqrt(b), c[0] = e[0] + d * a, c[1] = e[1] + d * f, d = 2; d < this.a; ++d) c[d] = e[d];
      else
  ...
  k.Th = function (a) {
    ...
    d = h;
    if (-1 == d) this.f.length = this.c.length = 0, this.b && (this.b.length = 0), this.a && (this.a.length = 0);
    else {
      f = this.D(e);
      e = f[0];
      f = f[1];
    ...
    if (this.b)
      for (a = 0, c = this.b.length; a < c; ++a) e = this.b[a], this.C.Cd(e.text), b.gb(this.C), b.Cb(e.Wd);
    if (this.a)
      for (a = 0, c = this.a.length; a < c; ++a) e = this.a[a], this.B.Cd(e.text), b.gb(this.B), b.Cb(e.Wd)
  };
  k.setMap = function (a) {
  ...
  function xt(a, b, c, d, e, f, g, h, l) {
    if (a.C && ma(d, a.U)) var m = a.C;
    else a.C || (a.C = []), m = mf(a.coordinates, 0, a.coordinates.length, 2, d, a.C), Hh(a.U, d);
    d = !ub(f);
    for (var n = 0, p = g.length, q = 0, t, u = a.jb, x = a.ta, B, z, G, E, ia = 0, T = 0, R = a.ga, U = {
      ...
      switch (A[0]) {
        ...
        case 9:
          ...
          for (q += 2; q < t; q += 2)
            if (A = m[q], Bc = m[q + 1], G = A + .5 | 0, E = Bc + .5 | 0, q == t - 2 || G !== B || E !== z) b.lineTo(A, Bc), B = G, z = E;
          ++n;
          break;
        case 10:
          a.S = A[2];
  ...
  Gt.prototype.Qb = function (a, b, c, d, e, f) {
    if ("" !== this.ua && this.g && (this.f || this.i)) {
      ...
      this.i && (e = this.i, g = this.D, g && g.lineCap == e.lineCap && g.lineDash == e.lineDash && g.lineDashOffset == e.lineDashOffset && g.lineJoin == e.lineJoin && g.lineWidth == e.lineWidth && g.miterLimit == e.miterLimit && g.strokeStyle == e.strokeStyle || (h = [11, e.strokeStyle, e.lineWidth,
        e.lineCap, e.lineJoin, e.miterLimit, e.lineDash, e.lineDashOffset, !1, 1
      ], this.a.push(h), this.b.push(h), g ? (g.lineCap = e.lineCap, g.lineDash = e.lineDash, g.lineDashOffset = e.lineDashOffset, g.lineJoin = e.lineJoin, g.lineWidth = e.lineWidth, g.miterLimit = e.miterLimit, g.strokeStyle = e.strokeStyle) : this.D = {
        lineCap: e.lineCap,
        lineDash: e.lineDash,
  ...
  Gt.prototype.gb = function (a) {
    if (a) {
      var b = a.Da();
      b ? (b = b.b, b = fd(b ? b : Uh), this.f ? this.f.fillStyle = b : this.f = {
        fillStyle: b
      }) : this.f = null;
      var c = a.Ea();
      if (c) {
  ...
  function du(a, b, c, d, e, f) {
    ...
    try{
		if (e = (0, c.$a)(b))
      if (d = e.$d(d), c.Je()) eu(a, d, c, b);
      else(0, fu[d.T()])(a, d, c, b);
	}
	catch(e){
  ...
  gu.prototype.u = function (a, b, c) {
    ...
    if (t && !t.c()) {
      ...
      Xh(z, l, E / 2, ia / 2);
      z != c && (B && $t(this, "render", z, a, p), x ? (d = c.globalAlpha, c.globalAlpha = b.opacity, c.drawImage(z.canvas, -q, -u), c.globalAlpha = d) : c.drawImage(z.canvas, -q, -u), z.translate(-q, -u));
      x || (z.globalAlpha = G)
    }
    g && c.restore();
    this.qf(c, a, b, p)
    ...
    a = function (a) {
      ...
      if (d) {
        if (d) {
          c = !1;
          if (Array.isArray(d))
            for (var e = 0, f = d.length; e < f; ++e) c = du(p, a, d[e], cu(l, m), this.D, this) || c;
          else c = du(p, a, d, cu(l, m), this.D, this) || c;
          a = c
        } else a = !1;
        this.c = this.c || a
      }
  ...
  nu.prototype.Qi = function (a, b, c) {
    ...
    var d = c.b,
      e = Ji(c, ju, lu);
    if (this.u) var f = this.u;
    else this.u = f = new mu(d, e);
    ...
    function d(a) {
      ...
      if (c) {
        if (c) {
          b = !1;
          if (Array.isArray(c))
            for (var d = c.length - 1; 0 <= d; --d) b = du(q, a, c[d], cu(m, n), this.Ri, this) || b;
          else b = du(q, a, c, cu(m, n), this.Ri, this) || b;
          a = b
        } else a = !1;
        this.o = this.o || a
      }
  ...
  function tu(a) {
    if ("string" === typeof a) return [new vc({
      html: a
    })];
  ...
  k.ee = function () {
    ...
    else this.a && (a = Lj(this.a), ub(this.g) || ka(a, tb(this.g)));
    return a
  };
  k.Hh = function (a) {
    var b = [];
  ...
  function Cu(a) {
    ...
    if (!b)
      if ("Circle" === this.S) b = function (a, b) {
  ...
  function fv(a) {
    ...
    if (c) {
      ...
      for (var g = 0, h = e.length; g < h; ++g) {
        ...
        p && (n += "-" + p.join("-"));
        f[n] || (f[n] = Array(2));
        if ("Circle" === l.geometry.T() && 1 === l.index) m = rv(b, l), bf(m, c) && !f[n][0] && (this.j.push([l, 0]), f[n][0] = l);
        else if (bf(m[0], c) && !f[n][0]) this.j.push([l, 0]), f[n][0] = l;
        else if (bf(m[1], c) &&
          !f[n][1]) {
  ...
  function kv(a, b, c) {
    ...
    if (0 < f.length) {
      ...
      if (n <= a.oa) {
        b = {};
        if ("Circle" === g.geometry.T() && 1 === g.index) a.va = !0, pv(a, l);
        else
          for (n = c.Ka(h[0]), g = c.Ka(h[1]), c = ef(m, n), m = ef(m, g), n = Math.sqrt(Math.min(c, m)), a.va = n <= a.oa, a.va && (l = c > m ? h[1] : h[0]), pv(a, l), m = 1, c = f.length; m < c; ++m)
            if (l = f[m].la, bf(h[0], l[0]) && bf(h[1], l[1]) || bf(h[0], l[1]) && bf(h[1], l[0])) b[w(l)] = !0;
            else break;
        b[w(h)] = !0;
        a.Za = b;
        return
  ...
  k.Ei = function (a) {
    if (a instanceof zu) var b = a.feature;
    else a instanceof Zc && (b = a.element);
    this.Bb(b)
  };
  k.Fi = function (a) {
    if (a instanceof zu) var b = a.feature;
  ...
  k.dm = function (a) {
    ...
    for (d = c.length; f < d; f += 4)
      if (e = 4 * c[f + 3]) c[f] = this.g[e], c[f + 1] = this.g[e + 1], c[f + 2] = this.g[e + 2];
    a.putImageData(b, 0, 0)
  };
  k.tj = function (a) {
    this.set(Ov, a)
    ...
    h.c.forEach(function (a) {
      ...
      a: {
        ...
        for (l = 0; l < h; l++) {
          ...
          g[l] = da;
          for (m = l + 1; m < h; m++)
            for (da = -g[m][l] / g[l][l], Vb = l; Vb < h + 1; Vb++) g[m][Vb] = l == Vb ? 0 : g[m][Vb] + da * g[l][Vb]
        }
        l = Array(h);
        for (m =
          h - 1; 0 <= m; m--)
          for (l[m] = g[m][h] / g[m][m], da = m - 1; 0 <= da; da--) g[da][h] -= g[da][m] * l[m];g = l
      }
  ...
  iw.prototype.vg = function (a, b) {
    ...
    l && (c = this.c.i.j, kw(this, c.width, c.height, d, f, g, h, l.G()), this.l = null, d = this.v, Eh(d), Kh(d, 1, -1), Lh(d, 0, -1), this.M = l, this.Hb = m, Ut(a.attributions, l.i), Vt(a, n));
    return !!l
  };
  ...
  k.vg = function (a, b, c) {
    var d = this.c,
      ...
      z = a.extent,
      G = nc(m, z, p);
    if (this.l && ya(this.l, G) && this.o == l.f) u = this.D;
    else {
      ...
      for (A = b.length; ta < A; ++ta)
        for (Vb in ea = c[b[ta]], ea) T = ea[Vb], da = m.Fa(T.sa, R), U[0] = 2 * (da[2] - da[0]) / E, U[1] = 2 * (da[3] - da[1]) / E, U[2] = 2 * (da[0] - u[0]) / E - 1, U[3] = 2 * (da[1] - u[1]) / E - 1, e.uniform4fv(this.i.c,
        ...
        for (T = z.length; G < T; ++G) {
          ...
          if (ta) {
            ...
            if (ta) {
              var Ya = !1;
              if (Array.isArray(ta))
                for (var da = 0, Vb = ta.length; da < Vb; ++da) Ya = du(ea, U, ta[da], A, this.Pi, this) || Ya;
              else Ya = du(ea, U, ta, A, this.Pi, this) || Ya;
              U = Ya
            } else U = !1;
            this.C = this.C || U;
            l.Sd = l.Sd || U
  ...
  function Ew(a, b, c, d, e, f, g, h, l, m, n) {
    ...
    f = h ? nb(f, h) : f;
    if (hb(f))
      if ((h = a.G()) && (e ? e = nb(e, h) : e = h), d = Sv(a, c, lb(f), d.Ca(this.l[0])), !isFinite(d) || 0 >= d) this.state = 4;
      else if (this.o = new Vv(a, c, f, e, d * (void 0 !== m ? m : .5)), this.o.c.length)
      if (this.g = b.uc(d), c = Xv(this.o), e && (a.f ? (c[1] = Aa(c[1], e[1], e[3]), c[3] = Aa(c[3], e[1], e[3])) : c = nb(c, e)), hb(c)) {
        a =
          kc(b, c, this.g);
        for (b = a.ca; b <= a.da; b++)
          for (c = a.ea; c <= a.ha; c++)(m = l(this.g, b, c, g)) && this.f.push(m);
  ...
  function Qt(a, b, c, d, e) {
    ...
    for (var f = !0, g, h, l = d.ca; l <= d.da; ++l)
      for (var m = d.ea; m <= d.ha; ++m) g = a.Rb(c, l, m), h = !1, b.b.hasOwnProperty(g) && (g = b.get(g), (h = 2 === g.getState()) && (h = !1 !== e(g))), h || (f = !1);
    return f
  }
  k.bg = function () {
    return 0
  ...
  Uw.prototype.oa = function (a) {
    if (200 != a.statusCode || "OK" != a.statusDescription || "ValidCredentials" != a.authenticationResultCode || 1 != a.resourceSets.length || 1 != a.resourceSets[0].resources.length) uu(this, "error");
    else {
  ...
  (function (a) {
    ...
    function f(a) {
      ...
      var c = [];
      if (b)
        for (var f = 0; f < b; ++f) c[f] = d(a, this.lh.bind(this, f));
      else c[0] = e(a, this.lh.bind(this,
        0));
      this.Ae = c;
      this.Jd = [];
  ...
  lx.prototype.Y = function (a, b, c, d) {
    ...
    for (var e, f = 0, g = this.g.length; f < g; ++f)
      if (e = this.g[f].a.ia(), "ready" !== e.getState()) {
        c = !1;
        break
      }
    if (!c) return null;
    ...
    if (!this.a || this.f !== this.S) a: {
      a = this.o;d = this.g.length;b = Array(d);
      for (e =
        0; e < d; ++e) {
        f = this.g[e];
        g = a;
      ...
      d = {};this.b(new px(qx, a, d));this.C.Cp(b, d, this.oa.bind(this, a))
    }
  ...
  lx.prototype.oa = function (a, b, c, d) {
    if (!b && c) {
      ...
      if (e === this.o.viewState.resolution && ab(b, this.o.extent)) {
        ...
        else f = gd(Math.round(jb(b) / e), Math.round(kb(b) / e)), this.a = new Zs(b, e, 1, this.j, f.canvas);
  ...
  function Ax(a) {
    ...
    if (a.url)
      if (a.jsonp) Dw(a.url, this.wg.bind(this), this.ff.bind(this));
      else {
  ...
  function Bx(a) {
    ...
    this.i = a.jsonp || !1;
    if (a.url)
      if (this.i) Dw(a.url, this.xg.bind(this), this.gf.bind(this));
      else {
        var b = new XMLHttpRequest;
  ...
  function Ex(a) {
    if (0 == a.state)
      if (a.state = 1, a.o) Dw(a.l, a.Ti.bind(a), a.Oe.bind(a));
      else {
        var b = new XMLHttpRequest;
      ...
      if (1 == c.state) {
        var d = y(c, "change", function () {
          ...
          if (2 == b || 3 == b) {
            ...
            zc(d);
            b = this.g;
            var f = b.indexOf(d); - 1 < f && b.splice(f, 1);
            a || this.zh()
          }
        }.bind(this));
        this.g.push(d);
  ...
  r("ol.loadingstrategy.tile", function (a) {
    return function (b, c) {
      ...
      for (c[1] = b.ca; c[1] <= b.da; ++c[1])
        for (c[2] = b.ea; c[2] <= b.ha; ++c[2]) d.push(a.Fa(c));
      return d
    }
  });
  r("ol.Map", H);
  ...
  r("ol.Observable.unByKey", function (a) {
    if (Array.isArray(a))
      for (var b = 0, c = a.length; b < c; ++b) zc(a[b]);
    else zc(a)
  });
  ...
  r("ol.source.WMTS.optionsFromCapabilities", function (a, b) {
    ...
    if ("OperationsMetadata" in a && "GetTile" in a.OperationsMetadata)
      for (a = a.OperationsMetadata.GetTile.DCP.HTTP.Get, t = 0, p = a.length; t < p; ++t) {
        var x = la(a[t].Constraint, function (a) {
          return "GetEncoding" == a.name
        }).AllowedValues.Value;
        "" === m && (m = x[0]);
        if ("KVP" === m) ha(x, "KVP") && u.push(a[t].href);
        else break
      }
