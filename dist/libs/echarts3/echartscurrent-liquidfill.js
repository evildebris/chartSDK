(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("echartscurrent"));
	else if(typeof define === 'function' && define.amd)
		define(["echartscurrent"], factory);
	else if(typeof exports === 'object')
		exports["echartscurrent-liquidfill"] = factory(require("echartscurrent"));
	else
		root["echartscurrent-liquidfill"] = factory(root["echartscurrent"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var echartscurrent = __webpack_require__(2);

	__webpack_require__(3);
	__webpack_require__(6);


	echartscurrent.registerVisual(
	    echartscurrent.util.curry(
...
/***/ function(module, exports, __webpack_require__) {
	...
	echartscurrent.extendSeriesModel({
	    ...
	    getInitialData: function (option, ecModel) {
	        ...
	        var list = new echartscurrent.List(dimensions, this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var echartscurrent = __webpack_require__(2);
	var numberUtil = echartscurrent.number;
	...
	echartscurrent.extendChartView({
	    ...
	    render: function (seriesModel, ecModel, api) {
	        ...
	        data.diff(oldData)
	            .add(function (idx) {
	                ...
	                echartscurrent.graphic.initProps(wave, {
	                    shape: {
	            ...
	            .update(function (newIdx, oldIdx) {
	                ...
	                echartscurrent.graphic.updateProps(waveElement, {
	                    shape: newWave.shape,
	                    style: newWave.style
	                }, seriesModel);
	        ...
	        function getPath(r, isForClipping) {
	            ...
	            if (symbol) {
	                ...
	                if (symbol.indexOf('path://') === 0) {
	                    var path = echartscurrent.graphic.makePath(symbol.slice(7), {});
	                    ...
	                    path = echartscurrent.graphic.makePath(
	                        symbol.slice(7),
	                        {},
	                        new echartscurrent.graphic.BoundingRect(left, top, width, height)
	                    );
	                    if (isForClipping) {
	            ...
	            return new echartscurrent.graphic.Circle({
	                shape: {
	        ...
	        function getBackground() {
	            ...
	            var group = new echartscurrent.graphic.Group();
	        ...
	        function getWave(idx, isInverse, oldWave) {
	            ...
	            echartscurrent.graphic.setHoverStyle(wave, hoverStyle);
	        ...
	        function getText(waves) {
	            ...
	            var outsideTextRect = new echartscurrent.graphic.Rect(textOption);
	            var color = textStyle.get('color');
	            echartscurrent.graphic.setText(outsideTextRect.style, labelModel, color);

	            var insideTextRect = new echartscurrent.graphic.Rect(textOption);
	            var insColor = textStyle.get('insideColor');
	            echartscurrent.graphic.setText(insideTextRect.style, labelModel, insColor);
	            ...
	            wavePath = new echartscurrent.graphic.CompoundPath({
	                shape: {
	                    paths: waves
	                },
	                position: [cx, cy]
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	     ...
	     * @param {module:echartscurrent/model/Model} labelModel
	     * @param {string} color
	     */
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = echartscurrent.graphic.extendShape({
	    type: 'ec-liquid-fill',
